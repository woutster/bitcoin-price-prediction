...
def make_plot(step, loss, accuracy):
    plt.plot(step, loss)
...
def generate_batch():
    X_data, y_data = gather_data.get_data(use_existing_data, single_data_array, label_threshold)
...
for step in range(int(train_steps)):
    ...
    loss_plot.append(np_loss)
    acc_plot.append(np_accuracy)

# import pdb; pdb.set_trace()

# make_plot(steps_plot, loss_plot, acc_plot)